...
public class A101TestOtomasyonPracticumFirstCase {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("title")).sendKeys("A101im");	  // adres bilgileri kýsmý
		...
		driver.findElement(By.xpath("//div[@class='form-area js-new-creditcard-area']//input[@name='name']")).sendKeys("Mehmed Said Taþdemir");
